...
// ----------------------------------------------------------
// PATCHED SIDEBAR COMPONENT (Option A — Vercel Dashboard Mode)
// ----------------------------------------------------------
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    <div
      ...
      data-side={side}
    >
      {/* Overlay when expanded — clicking collapses */}
      {state === "expanded" && (
        <div
      ...
      <div
        className={cn(
          ...
          // Width logic for icon-only collapsed mode
...
/* (ALL OTHER COMPONENTS BELOW ARE IDENTICAL TO YOUR ORIGINAL) */
...
/* (ALL OTHER COMPONENTS EXACTLY AS YOUR ORIGINAL FILE) */
